...
<main>
    ...
    <div class="container-xl mt-n10">
        <div class="row justify-content-center mb-2">
            <div class="col pb-2">
                <h1 class="text-dark fw-bolder m-0 d-flex align-items-center" style="font-weight: 900 !important">REPORT RECEIVE <span class="badge bg-orange small-text ms-2">OLD</span></h1>
...
<script>
    ...
    function simpanData() {
        ...
        var url = '<?php echo api_url('getReportReceiveItem'); ?>'
        var data = {
    ...
    function kelolaData(data, type, url, button) {
        $.ajax({
            ...
            success: function(response) {
                ...
                dateRangeString()
                $(button).prop("disabled", false);
                data_report = response.data.report_receive_item.data
                if (data_report) {
    ...
    function headTable() {
        ...
        html += '<th class="align-middle text-center small-text bg-white">Date Receive</th>'
    ...
    function exportExcel() {
        dataProfile = $('#selectDataProfile').val()
        var url = '<?= base_url('report/excelReceiveReport') ?>';
