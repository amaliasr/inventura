...
<script>
    ...
    function bodyHistory() {
        ...
        $.each(dataFind, function(key, value) {
            ...
            html += '<td class="bg-white align-middle small-text text-center">' + value.user_sender.name + '</td>'
            var totalQty = number_format(calculateTotals(value.details, 'qty'));
            var totalWeight = number_format(calculateTotals(value.details, 'weight'));
            html += '<td class="bg-white align-middle small-text text-center">' + totalQty + '</td>'
            html += '<td class="bg-white align-middle small-text text-center">' + totalWeight + '</td>'
