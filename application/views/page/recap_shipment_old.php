...
<main>
    ...
    <div class="container-xl mt-n10">
        <div class="row justify-content-center mb-2">
            <div class="col pb-2">
                <h1 class="text-dark fw-bolder m-0 d-flex align-items-center" style="font-weight: 900 !important">RECAP SHIPMENT <span class="badge bg-orange small-text ms-2">OLD</span></h1>
...
<script>
    ...
    function simpanData() {
        ...
        var url = '<?php echo api_url('getRecapShipmentItem'); ?>'
        var data = {
    ...
    function bodyTable() {
        ...
        $.each(data_report, function(key, value) {
            ...
            html += '<td class="bg-white align-middle small-text text-center">' + number_format(roundToTwo(value.qty)) + '</td>'
    ...
    function exportExcel() {
        var url = '<?= base_url('report/excelShipmentRecap') ?>';
