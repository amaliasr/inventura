...
<main>
    ...
    <div class="container-xl mt-n10">
        <div class="row justify-content-center mb-2">
            <div class="col pb-2">
                <h1 class="text-dark fw-bolder m-0 d-flex align-items-center" style="font-weight: 900 !important">REPORT SHIPMENT <span class="badge bg-orange small-text ms-2">OLD</span></h1>
                </h1>
