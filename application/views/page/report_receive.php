...
<main>
    ...
    <div class="container-xl mt-n10">
        <div class="row justify-content-center mb-2">
            <div class="col pb-2">
                <h1 class="text-dark fw-bolder m-0" style="font-weight: 900 !important">REPORT RECEIVE</h1>
...
<script>
    ...
    function simpanData() {
        ...
        var url = '<?php echo api_url('getReportReceiveItemNew'); ?>'
        var data = {
