...
<main>
    ...
    <div class="container-xl mt-n10">
        <div class="row justify-content-center mb-2">
            <div class="col pb-2">
                <h1 class="text-dark fw-bolder m-0 d-flex align-items-center" style="font-weight: 900 !important">RECAP PURCHASE <span class="badge bg-orange small-text ms-2">OLD</span></h1>
...
<script>
    ...
    function exportExcel() {
        ...
        var params = "*$" + warehouse_id + "*$" + date_start + "*$" + date_end + "*$" + itemId + "*$" + supplierId + "*$" + dataProfile + "*$OLD";
