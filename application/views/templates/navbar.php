...
<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion" style="color: #000 !important;">
    ...
    <a class="pe-3 ps-4 ps-lg-2" href="<?= base_url() ?>dashboard" style="width: 15em;">
        <div class="wrapper">
